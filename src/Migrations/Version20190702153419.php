 ...
 */
final class Version20190702153419 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(45) DEFAULT NULL, last_name VARCHAR(80) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quote (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, original_work_id INT DEFAULT NULL, text LONGTEXT NOT NULL, notes LONGTEXT DEFAULT NULL, INDEX IDX_6B71CBF4F675F31B (author_id), INDEX IDX_6B71CBF43DB4FD2C (original_work_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
